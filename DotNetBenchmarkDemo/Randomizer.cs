...
namespace ArrayVsDictionaryBenchmark
{
	...
	internal static class Randomizer
	{
		...
		public static string GetRandomAsciiString(int length)
		{
			...
			sb.Append(Convert.ToChar(random.Next(97, 122))); 
			sb.Append(Convert.ToChar(random.Next(65, 90))); 
			sb.Append(Convert.ToChar(random.Next(48, 57)));
			sb.Append(Convert.ToChar(s_punctuationACIICodes[random.Next(0, s_punctuationACIICodes.Length)])); 
